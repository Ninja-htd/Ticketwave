...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"  style="text-align:center; background: #125aeb; color:#fff;">{{ __("Inscription") }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                         ...
                         <p style="text-align:center;margin-left: 120px;">Si vous avez un compte <a href="{{ route('login') }}">
